...
//export HmacSha256
func HmacSha256(data *C.char, dataLen C.int, key *C.char, keyLen C.int, outLen *C.int) *C.char {
...
//export HmacSha1
func HmacSha1(data *C.char, dataLen C.int, key *C.char, keyLen C.int, outLen *C.int) *C.char {
	if dataLen < 0 || keyLen < 0 || (dataLen > 0 && data == nil) || (keyLen > 0 && key == nil) {
		*outLen = 0
		return nil
	}
