...
//export DesCbcEncrypt
func DesCbcEncrypt(plaintext *C.char, plaintextLen C.int, key *C.char, keyLen C.int, outLen *C.int) *C.char {
	if plaintext == nil || plaintextLen < 0 || key == nil || keyLen != 8 {
		*outLen = 0
		return nil
	}
...
//export DesCbcDecrypt
func DesCbcDecrypt(ciphertext *C.char, ciphertextLen C.int, key *C.char, keyLen C.int, outLen *C.int) *C.char {
	if ciphertext == nil || ciphertextLen <= 8 || key == nil || keyLen != 8 {
		*outLen = 0
		return nil
	}
