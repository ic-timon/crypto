...
static jbyteArray processResult(JNIEnv *env, void *result, int outLen) {
    if (result == NULL || outLen == 0) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
Java_mobi_timon_enc_Hash_sha1(JNIEnv *env, jobject obj, jbyteArray data) {
    if (data == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hash_sha256(JNIEnv *env, jobject obj, jbyteArray data) {
    if (data == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hash_sha512(JNIEnv *env, jobject obj, jbyteArray data) {
    if (data == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hash_blake2b256(JNIEnv *env, jobject obj, jbyteArray data) {
    if (data == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hash_md5(JNIEnv *env, jobject obj, jbyteArray data) {
    if (data == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Hmac ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hmac_hmacSha256(JNIEnv *env, jobject obj, jbyteArray data, jbyteArray key) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Hmac_hmacSha512(JNIEnv *env, jobject obj, jbyteArray data, jbyteArray key) {
    if (data == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Random ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Random_bytes(JNIEnv *env, jobject obj, jint length) {
    if (length <= 0) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Aead ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Aead_aesGcmEncrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Aead_aesGcmDecrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Aead_chacha20Poly1305Encrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Cbc ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Cbc_aesCbcEncrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Cbc_aesCbcDecrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Cbc_desCbcEncrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Cbc_desCbcDecrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Kdf ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Kdf_bcryptHash(JNIEnv *env, jobject obj, jbyteArray password, jint cost) {
    if (password == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
Java_mobi_timon_enc_Kdf_bcryptVerify(JNIEnv *env, jobject obj, jbyteArray password, jbyteArray hash) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Aead_chacha20Poly1305Decrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Stream_aesCtrEncrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Stream_aesCtrDecrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Stream_chacha20Encrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Stream_chacha20Decrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Xts_aesXtsEncrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray key, jlong sectorNum) {
    if (plaintext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Xts_aesXtsDecrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray key, jlong sectorNum) {
    if (ciphertext == NULL || key == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Kdf (advanced) ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Kdf_argon2idHash(JNIEnv *env, jobject obj, jbyteArray password, jbyteArray salt,
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Kdf_scrypt(JNIEnv *env, jobject obj, jbyteArray password, jbyteArray salt, jint keyLen) {
    if (password == NULL || salt == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Kdf_pbkdf2(JNIEnv *env, jobject obj, jbyteArray password, jbyteArray salt,
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Kdf_hkdf(JNIEnv *env, jobject obj, jbyteArray ikm, jbyteArray salt, jbyteArray info, jint keyLen) {
    if (ikm == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Rsa ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Rsa_generateKey(JNIEnv *env, jobject obj, jint bits) {
    int outLen = 0;
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Rsa_encrypt(JNIEnv *env, jobject obj, jbyteArray plaintext, jbyteArray publicKey) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Rsa_decrypt(JNIEnv *env, jobject obj, jbyteArray ciphertext, jbyteArray privateKey) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Rsa_sign(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray privateKey) {
...
JNIEXPORT jboolean JNICALL
Java_mobi_timon_enc_Rsa_verify(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray signature, jbyteArray publicKey) {
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Rsa_privateKeyToPublicKey(JNIEnv *env, jobject obj, jbyteArray privateKey) {
    if (privateKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Ecdsa ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Ecdsa_generateKey(JNIEnv *env, jobject obj, jint curveBits) {
    int outLen = 0;
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Ecdsa_sign(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray privateKey) {
    if (message == NULL || privateKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jboolean JNICALL
Java_mobi_timon_enc_Ecdsa_verify(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray signature, jbyteArray publicKey) {
    if (message == NULL || signature == NULL || publicKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Ecdsa_privateKeyToPublicKey(JNIEnv *env, jobject obj, jbyteArray privateKey) {
    if (privateKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
// === Ed25519 ===
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Ed25519_generateKey(JNIEnv *env, jobject obj) {
    int outLen = 0;
...
JNIEXPORT jbyteArray JNICALL
Java_mobi_timon_enc_Ed25519_sign(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray privateKey) {
    if (message == NULL || privateKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
...
JNIEXPORT jboolean JNICALL
Java_mobi_timon_enc_Ed25519_verify(JNIEnv *env, jobject obj, jbyteArray message, jbyteArray signature, jbyteArray publicKey) {
    if (message == NULL || signature == NULL || publicKey == NULL) {
        jclass excClass = (*env)->FindClass(env, "mobi/timon/enc/EncException");
